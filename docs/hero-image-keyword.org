...
The logic should be added to =ox-astro-image-handlers.el=, likely in or near the frontmatter generation code.
...
- [ ] Add =:hero-image= and =:hero-image-alt= to options-alist
- [ ] Implement =org-astro--get-hero-image= function
- [ ] Update frontmatter generation to use new function
- [ ] Handle path normalization for hero image
- [ ] Add tests

...
Implementation: See [[file:../ox-astro-helpers-core.el::org-astro--slugify][org-astro--slugify]]
...
Implementation: See [[file:../ox-astro-helpers-core.el::org-astro--path-to-var-name][org-astro--path-to-var-name]]
...
Keyword: =#+DESTINATION_FOLDER: blog= (aliases: =#+DESTINATION-FOLDER: blog=, =#+DESTINATION: blog=)
...
Implementation: See [[file:../ox-astro-helpers-core.el::org-astro--gen-yaml-front-matter][org-astro--gen-yaml-front-matter]]

** Keyword Mapping
The translation between Org keywords and MDX front matter fields:
- =#+TITLE= → =title=
- =#+DATE= or =#+PUBLISH_DATE= → =publishDate=
- =#+EXCERPT=, =#+SUBHED=, or =#+DESCRIPTION= → =excerpt= (ASTRO_EXCERPT > EXCERPT > SUBHED > DESCRIPTION > fallback paragraph)
- =#+COVER_IMAGE= → =image=
...
Implementation: See [[file:../ox-astro-helpers-core.el::org-astro--upsert-keyword-after-roam][org-astro--upsert-keyword-after-roam]]
...
Implementation: See [[file:../ox-astro-transcode.el::org-astro-heading][org-astro-heading]]
...
Implementation: See [[file:../ox-astro-image-handlers.el::org-astro--build-image-manifest][org-astro--build-image-manifest]]
...
Implementation: See [[file:../ox-astro-transcode.el::org-astro-src-block][org-astro-src-block]]

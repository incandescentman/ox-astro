...
*** Display Behavior
- *On page*: Credit appears as small gray text below the image
- *In lightbox*: Both credit (bold) and caption (italic) appear at the bottom
...
<a href={imgVar.src} data-pswp-item="true"
   data-pswp-caption="<strong>Image:</strong> Credit<br/><em>Caption</em>" ...>
...
*** Notes
- Keywords must immediately follow the image (or other IMAGE-* keywords for the same image)

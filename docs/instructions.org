...
- If you set =org-astro-id-link-base-path= (e.g., ="/notes"=), ID links emit extensionless absolute routes like =/notes/characters/rachel=; default =nil= keeps relative =.mdx= links.

...
- Explicit hero images (=HERO_IMAGE= / =COVER_IMAGE= / =ASTRO_IMAGE=) are suppressed from the body by default; fallback hero selection from the first inline image remains visible inline

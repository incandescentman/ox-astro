...
- ~ox-astro-image-handlers.el~:
  ...
  - Modified ~org-astro--materialize-image~ for GIF handling (lines 251-270)
  - Set ~:rewrite-path nil~ for local GIFs (line 268)
  - Set ~:rewrite-path nil~ for downloaded remote GIFs (line 300)

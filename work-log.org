...
** Summary
Created AI-generated OG images for watchlist and movies pages featuring Criterion Collection-style and film noir aesthetics. Images capture cinephile sophistication with rain/storm motifs and neon signage.
...
4. *Optimize for social sharing* - Work at small OG image sizes (1200x630px)

** Implementation

*** Watchlist Page OG Image
*File*: =/apps/jaydocs/public/man-criterion-2.png=
*Page*: =/watchlist=
...
*File*: =/apps/jaydocs/public/movies-motel.png=
*Page*: =/movies=
...
Updated Astro Layout component calls:
#+begin_src astro
// watchlist.astro
<Layout
  title="Watch List"
  description="Movies I want to watch"
  image="/man-criterion-2.png"
>
...
** Files Modified
- =apps/jaydocs/public/man-criterion-2.png= (new - 1.7M, Criterion style)
- =apps/jaydocs/public/man-criterion.png= (new - 1.9M, blue variant)
- =apps/jaydocs/public/motel-watchlist.png= (new - 2.0M, neon sign)
- =apps/jaydocs/public/movies-motel.png= (new - 2.3M, movies neon)
- =apps/jaydocs/src/pages/watchlist.astro= (added image prop)
- =apps/jaydocs/src/pages/movies.astro= (added image prop)
...
** Next Steps
- Consider OG images for other major pages (TV shows, itineraries, etc.)
- May experiment with consistent visual language across all OG images
- Could create matching hero images for actual page headers

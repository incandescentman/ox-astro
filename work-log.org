...
* 2025-11-02 Saturday - Pull Quote Support & Gallery Columns

** Summary
Added magazine-style pull quote support and fixed gallery :columns attribute parsing to enable single-row gallery layouts and typographically rich quotes with smart quotation marks.

** Goal
Enable two new content types for blog posts:
...
- Works in both Claude theme and default theme
...
- Complete pull quote usage guide with examples
...
- Created pull quote examples in Claude theme posts
...
*** astro-monorepo
- =apps/socratic/src/styles/claude-theme.css= - Pull quote styling
- =apps/socratic/src/layouts/MarkdownLayout.astro= - Default theme pull quotes

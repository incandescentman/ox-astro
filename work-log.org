...
- Reworked the manifest helper as a lexical closure (`register-entry`) to prevent stale references (`org-astro--manifest-register`) from breaking gallery exports.

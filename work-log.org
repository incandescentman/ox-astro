...
- =apps/jaydocs/public/watchlist-og.png= (new - optimized aspect ratio)
- =apps/jaydocs/public/movies-og.png= (new - optimized aspect ratio)

*** Page Updates
- =apps/jaydocs/src/pages/watchlist.astro= (added ogImage prop, updated to watchlist-og.png)
- =apps/jaydocs/src/pages/movies.astro= (added ogImage prop, updated to movies-og.png)

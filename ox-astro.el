...
(org-export-define-derived-backend 'astro 'md
  ...
  '((:smart-quotes       nil                   org-md-use-smart-quotes nil)
    ...
    (:hero-image         "HERO_IMAGE"          nil nil nil)
    (:hero-image         "HERO-IMAGE"          nil nil nil)
    (:hero-image-alt     "HERO_IMAGE_ALT"      nil nil nil)
    (:hero-image-alt     "HERO-IMAGE-ALT"      nil nil nil)
    ...
    (:hero-credit        "HERO-CREDIT"         nil nil nil)
    (:hero-credit        "HERO_CREDIT"         nil nil nil)
    (:hero-caption       "HERO-CAPTION"        nil nil nil)
    (:hero-caption       "HERO_CAPTION"        nil nil nil)
    (:hide-hero-image    "HIDE_HERO_IMAGE"     nil nil nil)
    (:hide-hero-image    "HIDE-HERO-IMAGE"     nil nil nil)
    (:astro-hide-hero-image "ASTRO_HIDE_HERO_IMAGE" nil nil nil)
    (:hide-toc           "HIDE_TOC"            nil nil nil)
    (:hide-toc           "HIDE-TOC"            nil nil nil)
    (:astro-hide-toc     "ASTRO_HIDE_TOC"      nil nil nil)
